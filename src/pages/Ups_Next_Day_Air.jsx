      ...
      {csvData &&
        ...
        csvData?.map((data, index) => {
          ...
          const maxiCodeImage = generateMaxiCodeImage(
            ...
            }${GS}840${GS}001${GS}${data[23]?.slice(0, 2)}${data[23]?.slice(
              data[23]?.length - 8,
              data[23]?.length
            )}${GS}UPSN${GS}${data[23]?.slice(2, 8)}${GS}079${GS}${GS}1/1${GS}${
              data[16]
            }${GS}N${GS}${data[10]}${GS}${data[9]}${GS}${data[12]}${GS}${data[13]}${RS}${EOT}`
          );
