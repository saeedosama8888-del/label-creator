...
import { groundAdvantageBarcodes, convertControlPictures } from "../utils/groundAdvantageBarcodes";
...
const USPS_Ground_Advantage_2_Copy = ({ csvData }) => {
                    ...
                    >
                      <View>
                        ...
                        <Text style={{ fontSize: 8 }}>
                          {data?.[16]} LB GROUND ADVANTAGE RATE
                        </Text>
                        <Text style={{ fontSize: 8 }}>
                          ZONE {calculatedZone}
                        </Text>
...
export default USPS_Ground_Advantage_2_Copy;
