...
const USPS_Priority_Pitney_Bowes = ({ csvData }) => {
              ...
              <View style={styles.container}>
                ...
                <View style={styles.topSection}>
                  ...
                  <View style={styles.gLogoSection}>
                    <Image
                      src="https://res.cloudinary.com/hassankhanw3/image/upload/v1760230810/Screenshot_2025-10-11_at_5.59.50_pm_bfhiu0.png"
                      style={styles.gImage}
                    />
                  </View>
                  ...
                  <View style={styles.postageSection}>
                    ...
                    <View style={styles.postageBottom}>
                      ...
                      <View style={{ alignItems: "flex-end" }}>
                        <Text style={{ fontSize: 8 }}>028W0006492305</Text>
                ...
                <View style={styles.banner}>
                  <Text style={styles.bannerText}>USPS PRIORITY MAIL™</Text>
                </View>
...
export default USPS_Priority_Pitney_Bowes;
