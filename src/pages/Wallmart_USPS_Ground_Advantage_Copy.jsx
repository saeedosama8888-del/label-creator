...
const Wallmart_USPS_Ground_Advantage_Copy = ({ csvData }) => {
      ...
      {csvData &&
        ...
        csvData?.map((data, index) => {
          ...
          const pfd147Barcode = generatePdf147(
            `v0901S,\u00e4${data?.[23]}75${firstPart.toString().padStart(5, "0")}`,
          );
          ...
          return (
            ...
            >
              <View style={styles.topRow}>
                ...
                <View style={styles.postageInfo}>
                  ...
                  <View style={styles.flexRow}>
                    <View>
                      <Text>{data?.[6]}</Text>
                      <Text style={{ marginTop: 2 }}>C4190745</Text>
                  ...
                  <View style={[styles.flexRow, { marginTop: 4, fontSize: 9 }]}>
              ...
              <View style={styles.advantageView}>
                <Text style={styles.serviceLabel}>USPS GROUND ADVANTAGE</Text>
                <Text style={{ fontWeight: 500, marginTop: 3, fontSize: 6 }}>
                  TM
                </Text>
              </View>
...
export default Wallmart_USPS_Ground_Advantage_Copy;
